...
static const char *fonts[] = {"Iosevka:size=10",
                              "Iosevka Nerd Font Mono:size=14"};
...
static char *colors[][3] = {
    ...
    [SchemeTitle] = {selbordercolor, normbordercolor, normbordercolor},
};

/* tagging */
static const char *tags[] = {"[cmd]", "[www]", "[dev]", "chat", "sys", "med"};
...
static const char sccmd[] =
    "maim -s -u | xclip -selection clipboard -t image/png";
static const char compositorcmd[] = "pgrep picom >/dev/null && pkill picom || "
...
static const Key keys[] = {
    ...
    {MODKEY | ShiftMask, XK_s, spawn, SHCMD(sccmd)},
    {MODKEY | ShiftMask, XK_o, spawn, SHCMD(compositorcmd)},
